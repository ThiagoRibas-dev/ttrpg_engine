# Rogue
## Description
Rogues are masters of stealth, deception, and cunning. They excel at bypassing obstacles, disarming traps, and striking from the shadows. Rogues are often found in urban environments, operating as spies, thieves, or assassins, but their skills are valuable in any adventuring party. They are highly adaptable and can fill various roles, from scout to damage dealer, and are known for their ability to exploit an opponent's vulnerabilities with sneak attacks.
