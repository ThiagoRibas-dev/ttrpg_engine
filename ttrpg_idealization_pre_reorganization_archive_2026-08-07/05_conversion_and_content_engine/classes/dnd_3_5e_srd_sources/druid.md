# Druid
## Description
Druids are divine spellcasters who draw their power from the raw forces of nature. They are protectors of the wild, guardians of ancient forests, and conduits for the primal energies of the world. Druids are often found in remote wilderness areas, living in harmony with the natural world and defending it from those who would exploit or corrupt it. Their alignment is typically neutral, reflecting the balance of nature. They can transform into animals and command the creatures of the wild.
